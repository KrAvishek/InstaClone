...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://instaclone-bp7h.onrender.com/api/v1/user/profile/edit', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                },
                withCredentials: true
            ...
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div>
                    ...
                    <Textarea
                        ...
                        name='bio'
                        className="resize-none min-h-[6rem] max-h-[12rem] p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
